...
urlpatterns = [
    ...
    path('avancements/', views.liste_avancements, name='liste_avancements'),
    path('ajouter_avancement/', views.ajouter_avancement, name='ajouter_avancement'),
    path('modifier_avancement/<int:pk>/', views.modifier_avancement, name='modifier_avancement'),
    path('avancements/supprimer/<int:pk>/', views.supprimer_avancement, name='supprimer_avancement'),
